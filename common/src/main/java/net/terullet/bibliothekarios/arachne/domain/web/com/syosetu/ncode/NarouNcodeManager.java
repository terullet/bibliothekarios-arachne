...
public class NarouNcodeManager {
	...
	public CompletionStage<List<NarouEpisodeResponseMetadata>> fetchEpisodeListAsync(NarouWorkNcodeQuery work, RequestSource requestSource) {
		WorkFetchProgress wfp = new WorkFetchProgress(work, requestSource);
		return wfp.targetCompletableFuture;
	}

	public CompletionStage<List<String>> fetchEpisodeContentAsync(NarouEpisodeNcodeQuery episode, RequestSource requestSource) {
		// TODO: retry.
	...
	private class WorkFetchProgress {
		private final NarouWorkNcodeQuery work;
		...
		WorkFetchProgress(NarouWorkNcodeQuery work, RequestSource requestSource) {
			this.work = work;
